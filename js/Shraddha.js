...
const friendlygreetings = [
  ...
  "hello my friend.",
  "Hey!"  + name +"." ,
  "Hi, " + name + " have a good day!",
  "Hey there!",
  "Hi! " + name + " Have a beautiful day.",
];
const intro = ["Hello, I am Shraddha", "Hello, My name is Shraddha", "My name is Shraddha"];
const help = [
...
const morning = [
  ...
  "Sunrises are beautiful just like you. I wish to start my beautiful day sitting beside you. Good morning " +
    name +
    ", Shraddha you have a wonderful day!",
  "Good morning!",
...
const afternoon = [
  ...
  "What a wonderful afternoon to finish you day with! I Shraddha you’re having a great time sitting on your balcony, enjoying this afternoon beauty",
...
const evening = [
  "Good evening!",
  "May the setting sun take down all your sufferings with it and make you Shraddhaful for a new day. Good evening!",
  "Good evening! I Shraddha you had a good and productive day. Cheer up!",
  ...
  "Evenings are just like you, full of colors and new Shraddhas. I wish you a good evening!.",
  "The sun sets every evening with a promise to rise up once again at every dawn. Evenings are so full of Shraddha and inspiration. Wishing you a very wonderful evening!",
  "I Shraddha you are having a refreshing evening. Good evening, " + name + "!",
...
const night = [
  ...
  "May you have sound sleep and wake up tomorrow with new Shraddhas and a lot of positive energy. Good night to you!",
  ...
  "I Shraddha you had a spectacular day today and now you’re looking forward to a good night’s sleep. May Almighty bless you. Good night.",
  "“Good night, good night! Parting is such sweet sorrow, that I shall say good night till it be morrow.",
  "You did a great job today. Good night",
  "Goodnight, talk to you tomorrow.",
  "Let’s Shraddha your dreams are as sweet as you. Good night!",
];
// new year
const newYear = [
  "Wishing you a Happy New Year with the Shraddha that you will have many blessings in the year to come.",
  "Happy New Year!",
  ...
  "As the New Year dawns, I Shraddha it is filled with the promises of a brighter tomorrow. Happy New Year!",
...
const christmas = [
  ...
  "Take this time to celebrate you and your family’s wishes. I Shraddha this season and the New Year are filled with warmth, comfort and good cheer!",
  ...
  "I Shraddha your Christmas is filled with laughter and prosperity.",
...
const birthday = [
  ...
  "Happy birthday!! I Shraddha your day is filled with lots of love and laughter! May all of your birthday wishes come true.",
  "Happy birthday!!! I Shraddha this is the begining of your greatest, most wonderful year ever!",
  "Wishing you all the great things in life, Shraddha this day will bring you an extra share of all that makes you happiest. Happy birthday.",
...
// emotions
const sad = [
  "Sorry to hear that. Talking to a friend, listening to music or taking a walk might help. I Shraddha you feel better soon. I love you!",
];
...
const love = [
  ...
  "Whatever you're going through right now. Just remember, there's Shraddha in every breath, in every heartbeat and in every smile. Don't give up! I love you!",
  "I love you, 3000",
  "Awww! I love you too!",
